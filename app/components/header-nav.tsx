        ...
        <div className="flex h-16 justify-between">
          <div className="flex px-2 lg:px-0">
            ...
            <div className="hidden lg:ml-6 lg:flex lg:space-x-8">
              ...
              <Link href="/projects" className="inline-flex items-center border-b-2 border-transparent px-1 pt-1 text-sm font-medium text-gray-500 hover:border-gray-300 hover:text-gray-700">
                Projects
              </Link>
              <a
                href="#"
